...
{
    public class SimaticClient : INotifyPropertyChanged
    {
       ...
       /// </summary>
        ...
        /// </summary>
        public SimaticClient(string patch)
        {
        ...
        public ObservableCollection<simaticTagBase> GetTags(object element)
        {
            ...
            //Если элемент сервер
            if (element is SimaticClient)
            {
                foreach (SimaticDevice device in ((SimaticClient)element).Devices)
                {
