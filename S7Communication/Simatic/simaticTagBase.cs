...
namespace S7Communication
{
    public class simaticTagBase : INotifyPropertyChanged
    {
        ...
        public object Status
        {
            ...
            set
            {
                ...
                if (status.Equals(value) == false)
                {
                    ...
                    //Извещение подписчиков если имеется разрешение
                    //на вызов
                    if (InvokeChangeValueEnable == true)
                    {
        ...
        /// <summary>
        /// Разрешение для вызова 
        /// события по изменению тэга
        /// </summary>
        public bool InvokeChangeValueEnable = true;
